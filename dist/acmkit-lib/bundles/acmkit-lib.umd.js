(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material/tooltip'), require('@angular/platform-browser'), require('@angular/platform-browser/animations'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('acmkit-lib', ['exports', '@angular/core', '@angular/material/tooltip', '@angular/platform-browser', '@angular/platform-browser/animations', '@angular/router'], factory) :
    (global = global || self, factory(global['acmkit-lib'] = {}, global.ng.core, global.ng.material.tooltip, global.ng.platformBrowser, global.ng.platformBrowser.animations, global.ng.router));
}(this, (function (exports, core, tooltip, platformBrowser, animations, router) { 'use strict';
